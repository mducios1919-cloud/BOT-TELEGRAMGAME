...
import base64, hashlib, time, re, os, json, urllib3, ssl
...
# ===== TẠO SSL CONTEXT CHO PHÉP TỰ KÝ =====
...
def get_scraper():
    """Tạo cloudscraper session KHÔNG verify SSL"""
    ...
    # KHÔNG dùng verify=False nữa
    # scraper.verify = False  # <-- XÓA DÒNG NÀY
